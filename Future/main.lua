return (function()
    ...
    do
        ...
        GuiLibrary.Signals.UpdateColor = CreateSignalContainer()
    end
    local MainGui = Instance.new("ScreenGui")
    MainGui.Name = "ClickGUI_Main"
    MainGui.ResetOnSpawn = false
    MainGui.Parent = CoreGui
    local ToggleGui = Instance.new("ScreenGui")
    ToggleGui.Name = "ClickGUI_Toggle"
    ToggleGui.ResetOnSpawn = false
    ToggleGui.Parent = CoreGui
    local MobileToggleButton = Instance.new("TextButton")
    MobileToggleButton.Name = "MobileToggleButton"
    MobileToggleButton.Parent = ToggleGui
    MobileToggleButton.AnchorPoint = Vector2.new(1, 1)
    MobileToggleButton.Size = UDim2.new(0, 48, 0, 48)
    MobileToggleButton.Position = UDim2.new(1, -12, 1, -12)
    ...
    local MobileToggleCorner = Instance.new("UICorner", MobileToggleButton)
    ...
    function GuiLibrary:CreateWindow(Args)
        ...
        function WindowApi:CreateOptionsButton(ArgsButton)
            ...
            GearButton.TextColor3 = Color3.fromRGB(181, 181, 181)
            ...
            local ConnA = ModuleListLayout:GetPropertyChangedSignal("AbsoluteContentSize"):Connect(function() pcall(function() ButtonApi:Update() end) end)
            local ConnB = ChildrenListLayout:GetPropertyChangedSignal("AbsoluteContentSize"):Connect(function() pcall(function() ButtonApi:Update() end) end)
            ...
            function ButtonApi:CreateToggle(ArgsToggle)
                ...
                GuiLibrary.Objects[OptionsButton.Name .. tostring(ArgsToggle.Name or "Toggle") .. "Toggle"] = { API = ToggleApi, Instance = ToggleBtn, Type = "Toggle", OptionsButton = OptionsButton.Name, Window = Window.Name }
                return ToggleApi
            end
            function ButtonApi:CreateSelector(ArgsSelector)
                ...
                SelectorBtn.Text = ""
                SelectorBtn.TextColor3 = Color3.fromRGB(0, 0, 0)
                ...
                GuiLibrary.Objects[OptionsButton.Name .. tostring(ArgsSelector.Name or "Selector") .. "Selector"] = { API = SelectorApi, Instance = SelectorBtn, Type = "Selector", OptionsButton = OptionsButton.Name, Window = Window.Name }
                return SelectorApi
            end
            function ButtonApi:CreateSlider(ArgsSlider)
                ...
                GuiLibrary.Objects[OptionsButton.Name .. tostring(ArgsSlider.Name or "Slider") .. "Slider"] = { API = SliderApi, Instance = SliderBtn, Type = "Slider", OptionsButton = OptionsButton.Name, Window = Window.Name }
                return SliderApi
            end
            function ButtonApi:CreateTextbox(ArgsTextbox)
                ...
                GuiLibrary.Objects[OptionsButton.Name .. tostring(ArgsTextbox.Name or "Textbox") .. "Textbox"] = { API = TextboxApi, Instance = TextboxBtn, Type = "Textbox", OptionsButton = OptionsButton.Name, Window = Window.Name }
                return TextboxApi
            end
            GuiLibrary.Objects[tostring(ArgsButton.Name or "Option") .. "OptionsButton"] = { Name = ArgsButton.Name, API = ButtonApi, Instance = OptionsButton, Type = "OptionsButton", Window = Window.Name, DisableOnLeave = ArgsButton.DisableOnLeave, ArrayText = ArgsButton.ArrayText }
            ButtonApi:Update()
            return ButtonApi
        end
        ...
        local Conn = ButtonListLayout:GetPropertyChangedSignal("AbsoluteContentSize"):Connect(function() pcall(function() WindowApi:Update() end) end)
